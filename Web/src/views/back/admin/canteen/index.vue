...
<template>
  <div style="margin: 20px">
    ...
    <el-table :data="data" style="width: 100%; margin-top: 20px;" stripe border>
      ...
      <el-table-column prop='grade' label='卫生等级'></el-table-column>
...
const searchData = async () => {
  try {
    ...
    const response = await axios.post('/api/search/canteen/', searchQuery.value, {params});
